...
// Função: Percorre o array e TRANSFORMA cada item, retornando um NOVO array com o mesmo tamanho do original.

console.log("=== EXEMPLOS COM map() ===z\n");
...
// Exemplo 2 (Intermediário): Extração de propriedades m array de objetos
...
const produtosBanco = [
    ...
    { id: 102, nome: "Monitor 144Hz IPS", preco: 1100.0, estoque: 8, custoInterno: 700.0 }
];
