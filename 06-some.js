...
// Exemplo 3 (Back-End Real): Alerta de reposição d estoque
...
function checar(produtos) {
    ...
    return "Ok: Todos os produtos possuem esqtoque.";
}

console.log(checar(inventario));
